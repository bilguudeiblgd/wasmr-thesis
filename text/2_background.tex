...
\subsection{WASM Garbage Collection Purposal}
WASM Garbage collection purposal, in short GC, is a new purposal that tries to provide efficient support
for high-level languages. Since WASM announcement, community were coming up with their own 
GC as a way to compile high-level languages to WASM. With GC purposal, it helps to take load off of developers
who are porting their languages to WASM. In this purposal, they introduced structs and arrays, which we'll heavily 
