...
WASM Garbage collection proposal, in short GC, is a new proposal that tries to provide efficient support
...
who are porting their languages to WASM. In this proposal, they introduced structs and arrays, which we'll heavily 
use in the implementation of this thesis. 
