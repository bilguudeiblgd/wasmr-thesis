...
It's a form where bytecode itself is more readable, with more syntactic sugars. Let's iterate over properties of WASM and how it's structured and written in WAT format. From personal, experience WAT format really eases development and debugging process by removing friction of using different tools to analyze the bytecode.
